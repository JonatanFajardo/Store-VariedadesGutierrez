...
if( animation === false ) {
  ...
  css.type = "text/css";
  css.innerHTML += "#slider { text-align: left; margin: 0; font-size: 0; position: relative; width: " + (imgCount * 100) + "%;  }\n"; // set the width for the slider container
  ...
  css.innerHTML += "}\n";
  css.innerHTML += "#slider { left: 0%; "+keyframeprefix+"transform: translate3d(0,0,0); "+keyframeprefix+"animation: "+totalTime+"s slider infinite; }\n"; // call on the completed keyframe animation sequence
...
function CardsFilter() {
  ...
  cardContainer = document.getElementById("cards-filter");
  cards = cardContainer.getElementsByClassName("cards-item");
